    ...
    <div class="container">
        <div class="container_form">
            ...
            <form action="registration_check.php" method="POST" class="form">
                ...
                <div>
                    <label class="write_login">Inserisci il nome</label>
                </div>
                ...
                <div class="cont_label">
                    <label class="write_login">Inserisci il cognome</label>
                </div>
                    ...
                    <?php if (isset($_GET['cognome'])) { ?>
                        <input 
                            ...
                            name="cognome" 
                            placeholder="Cognome"
                            value="<?php echo $_GET['cognome']; ?>"><br>
                    <?php } else{ ?>
                        <input type="text" 
                            name="cognome" 
                ...
                <button type="submit" class="button" style="margin-top: 30px;">REGISTRATI</button><br>
                <div class="link ">
                    <div class="register">
                        <a href="index.php" >Hai già un account? <span class="power_link">Accedi</span></a>
                    </div>
                </div>
